import {
  useSearchState,
  DirectAnswerType,
  DirectAnswer as DirectAnswerModel,
...
export default function DirectAnswer(
  ...
  const cssClasses = getCssClassesForAnswerType(
    composedCssClasses,
    directAnswerResult.type
  );
      ...
      <>
        {isSnippet && name && (
          <div className={cssClasses.viewDetailsLinkContainer}>
            Read more about{" "}
            <a className={cssClasses.viewDetailsLink} href={link}>
...
function getCssClassesForAnswerType(
  ...
  return {
    ...cssClasses,
    title: isSnippet
      ? cssClasses.featuredSnippetTitle
      : cssClasses.fieldValueTitle,
    description: isSnippet
      ? cssClasses.featuredSnippetDescription
      : cssClasses.fieldValueDescription,
  };
}
